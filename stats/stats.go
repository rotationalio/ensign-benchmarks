...
See: https://bbengfort.github.io/2017/08/online-distribution/ for more on
the implementation details and choice of locking methodology.
*/
package stats
...
func (s *Statistics) MarshalJSON() ([]byte, error) {
	...
	data["range"] = s.maximum - s.minimum
